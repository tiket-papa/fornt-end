  ...
  return (
      <>
          ...
          <footer className="footer container mx-auto">
              ...
              <div className="information grid grid-cols-5 my-10">
                  ...
                  <div className="office col-span-2">
              ...
              <div className="grid grid-cols-2 py-5 mt-6">
                  <div className="text-gray-500">
                      <span>Copyright © 2023 TIKETPAPA | All Rights Reserved </span>
                  </div>
                  <div className="flex gap-10 justify-end text-main-color text-2xl">
