  ...
  return (
      <main className="h-screen grid grid-cols-2 bg-gray-100">
          <div className="relative">
              <div className="absolute w-full h-1/3 bottom-0 grid grid-cols-5 grid-rows-3 gap-2">
              ...
              <div className="absolute z-20 w-full h-[70vh] flex px-10 gap-5 flex-col justify-center items-center">
                  ...
                  <p className='font-semibold text-gray-500'>Login Untuk melihat selengkapnya</p>
              </div>
          </div>
          <div className="relative p-0 m-0">
              <div className="absolute z-30 rounded-l-2xl shadow-2xl w-full h-full flex justify-center items-center bg-white">
                  <LoginForm />
              </div>
          </div>
      </main>
